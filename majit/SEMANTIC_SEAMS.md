...
- [majit-analyze/src/lib.rs](majit/majit-analyze/src/lib.rs)
- [majit-analyze/src/codegen.rs](majit/majit-analyze/src/codegen.rs)
- [pyre-mjit/build.rs](pyre/pyre-mjit/build.rs)
...
Current majit owners:
- [jit_interp/mod.rs](majit/majit-macros/src/jit_interp/mod.rs)
- [codegen_trace.rs](majit/majit-macros/src/jit_interp/codegen_trace.rs)
- [jitcode_lower.rs](majit/majit-macros/src/jit_interp/jitcode_lower.rs)
- [jitcode.rs](majit/majit-meta/src/jitcode.rs)
...
Current majit owners:
- [trace_ctx.rs](majit/majit-meta/src/trace_ctx.rs)
- [recorder.rs](majit/majit-trace/src/recorder.rs)
- [parity.rs](majit/majit-meta/src/parity.rs)
...
- example: [majit-analyze/src/lib.rs](majit/majit-analyze/src/lib.rs)
...
- example: inline arithmetic lowered through [jitcode_lower.rs](majit/majit-macros/src/jit_interp/jitcode_lower.rs)

3. Runtime seam tests
- validate that `TraceCtx` / `TraceRecorder` produce the expected normalized trace
- example helper: [parity.rs](majit/majit-meta/src/parity.rs)
...
- `pyjitpl` arithmetic execution
  ...
  - majit: macro lowering in `jitcode_lower.rs` + generic `JitCode` execution in [jitcode.rs](majit/majit-meta/src/jitcode.rs) + runtime seam in `TraceCtx`
